...
echo "  G-M2-IPC=LANDED (SealUnderSession; M2 evidence CLOSED; NON-RELEASE; ≠ O6 E2E Proven)"
echo "  G-M2-PY=LANDED_COMPANION (RDAP 3207e8ea raven_ipc; M2 evidence CLOSED; ≠ O6 E2E Proven)"
echo "  G-M3=MISSING (no two-device RDAP harness / execute evidence)"
echo "  G-CI=MISSING (no Raven↔RDAP interop job)"
echo
echo "next_authorized_code_pr=none (honesty only; M2 evidence CLOSED; HOLD intact; not O6 Proven)"
